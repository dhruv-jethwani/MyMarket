...
function Register() {
    ...
    const inputStyle = "w-full px-4 py-2 mt-1 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none border-gray-300 bg-white text-gray-900 transition-all";
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-lg">
                <div className="bg-white py-8 px-6 shadow-xl shadow-slate-200/50 rounded-2xl border border-slate-100 sm:px-12">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-1">
                        ...
                        <div>
                            ...
                            <input {...register("password")} type="password" className={inputStyle} placeholder="••••••••" />
                        ...
                        <div className="pt-8">
                            <button 
                                type="submit" 
                                className="w-full py-3 px-4 rounded-xl shadow-lg shadow-blue-200 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 hover:-translate-y-0.5 transition-all active:scale-[0.98]"
                            >
                                Create Account
                            </button>
                        </div>
